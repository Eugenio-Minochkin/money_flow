export const translations = {
  ru: {
    ...
    "dashboard.tooltip.month.body": "Плановые платежи здесь НЕ вычтены — их считает карточка «До конца месяца». Полоска показывает, какую долю бюджета ты уже израсходовал.",
    "dashboard.tooltip.monthFree.title": "Деньги, которыми реально можно распоряжаться до конца месяца.",
    "dashboard.tooltip.monthFree.body": "Плановые платежи мы уже отложили в сторону — так что эту сумму можно тратить без неприятных сюрпризов в конце месяца.",
    "dashboard.tooltip.planned.title": "Деньги, которые, считай, уже потрачены: аренда, подписки и другие платежи впереди.",
    "dashboard.tooltip.planned.body": "Держим их отдельно, чтобы они не попали в «свободные» и не растворились по дороге.",
    "dashboard.tooltip.heroToday.title": "Твой безопасный лимит на сегодня.",
    "dashboard.tooltip.heroToday.body": "Уложишься — план на месяц цел. Считаем просто: все свободные деньги до конца месяца (плановые уже отложены) делим на оставшиеся дни. Сэкономишь сегодня — завтра лимит будет больше.",
    "dashboard.tooltip.week.title": "Лимит на эту неделю — но не больше, чем разрешает месяц.",
    "dashboard.tooltip.week.body": "По недельному темпу свободно {weeklyPace}, но месяц даёт только {monthlyAllowance} — берём меньшее. Так одна щедрая неделя не оставит тебя без денег к концу месяца.",
  ...
  en: {
    ...
    "dashboard.tooltip.month.title": "What's left of your monthly budget: {remaining} of {budget} ({spent} spent).",
    "dashboard.tooltip.month.body": "Planned bills aren't subtracted here — that's the 'Left for the month' card's job. The bar shows how much you've used.",
    "dashboard.tooltip.monthFree.title": "The money that's genuinely free to spend before month-end.",
    "dashboard.tooltip.monthFree.body": "We've already set the planned bills aside, so spending this won't ambush you on the 30th.",
    "dashboard.tooltip.planned.title": "Money that's basically already gone: rent, subscriptions, and other bills on the way.",
    "dashboard.tooltip.planned.body": "We keep it separate so it doesn't leak into your 'free' balance and vanish.",
    "dashboard.tooltip.heroToday.title": "Your safe-to-spend number for today.",
    "dashboard.tooltip.heroToday.body": "Stay under it and the month stays on track. The math: all your free money until month-end (planned bills already set aside) ÷ days left. Save today, tomorrow's number goes up.",
    "dashboard.tooltip.week.title": "Your limit for the week — but never more than the month can afford.",
    "dashboard.tooltip.week.body": "Your weekly pace says {weeklyPace}; the month only allows {monthlyAllowance}, so we take the smaller one. One generous week won't leave you broke by month-end.",
