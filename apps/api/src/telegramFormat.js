...
const messages = {
  ru: {
    aboveBy: "выше бюджета на",
    belowBy: "ниже бюджета на",
    budget: "Бюджет",
    ...
    plan: "По прогнозу",
    planned: "Плановые",
    reservedPlanned: "В резерве на плановые",
    freeAfterPlanned: "Свободно после плановых",
    ...
    holdPace: "Чтобы уложиться в бюджет, держи обычные расходы в пределах",
    today: "Сегодня",
  ...
  en: {
    aboveBy: "over budget by",
    belowBy: "under budget by",
    budget: "Budget",
    ...
    planned: "Planned",
    reservedPlanned: "Reserved for planned payments",
    freeAfterPlanned: "Free after planned payments",
    ...
    spent: "Spent",
    status: "Status",
    returnToBudget: "Get back on budget",
    forecastAboveBudget: "forecast is over budget by",
    holdPace: "To stay within budget, keep regular spending within",
    today: "Today",
