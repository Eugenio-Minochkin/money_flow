...
const DEFAULT_OPENAI_IMAGE_ANALYSIS_USER_LIMIT = 100;
...
export function buildConfig(env) {
  ...
  return {
    ...
    openAiImageAnalysisGlobalEnabled: env.OPENAI_IMAGE_ANALYSIS_GLOBAL_ENABLED !== "false",
    openAiImageAnalysisUserLimit: parsePositiveInteger(env.OPENAI_IMAGE_ANALYSIS_USER_LIMIT, DEFAULT_OPENAI_IMAGE_ANALYSIS_USER_LIMIT),
