...
- An independent text expense can finish while an earlier text expense waits for parsing. Each result stays linked to its own input; commands, editing and other stateful actions preserve their order.
