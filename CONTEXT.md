...
**Архив отключённых плановых трат (Disabled Planned Expense Archive)**:
Доступная только для чтения история отключённых плановых трат, включая сохранённые сведения об отключении и фактически состоявшихся оплатах; архивные записи не являются активными обязательствами.
_Avoid_: Корзина, список активных планов, восстановимые планы

**Повторное создание плановой траты (Planned Expense Recreate)**:
Осознанное создание нового независимого активного плана на основе архивного, при котором исходный план и его история остаются неизменными, а оплаты не наследуются. Одну архивную запись можно использовать повторно, и каждое подтверждение создаёт отдельный новый план.
_Avoid_: Восстановление плана, повторная активация, перенос истории оплат

**Дата начала плановой траты (Planned Expense Start Date)**:
Локальная календарная дата пользователя, начиная с которой повторно созданный план может формировать обязательства; более ранние occurrence не существуют для расчётов и оплаты.
_Avoid_: Время создания, timestamp активации, дата восстановления
...
**Отмена оплаты планового обязательства (Planned Payment Undo)**:
Явное действие, которое отменяет только указанное оплаченное occurrence: удаляет его payment link и единственный связанный same-user расход, снова делая occurrence неоплаченным. Это не удаление записи истории, не реактивация плана и не общее восстановление расхода.
_Avoid_: Отмена последней оплаты, удаление всего payment history, общий Undo framework
